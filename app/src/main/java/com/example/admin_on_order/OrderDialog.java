...
public class OrderDialog extends Dialog {
    ...
    private TextView orderOk, orderCancel, orderReissue, orderCancelPayment, btnOrderCheck, orderCount;
    ...
    Context context;
    String key;
    ArrayList<OrderModel> body;
    String tableNo;
    String totalPrice;
    public OrderDialog(@NonNull Context context, int position, ArrayList<OrderModel> body, String no, String price, String tableNo, String totalPrice,
                       String checkStatus, String orderTime) {
        super(context);
    ...
    public OrderDialog(@NonNull Context context, ArrayList<OrderModel> body, String tableNo, String totalPrice, String checkStatus,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < body.size(); i++) {
            bodyText = bodyText +body.get(i).getName()+"   "+body.get(i).getCount()+"개"+"\n";
        }
        orderBody.setText(bodyText);
...
//                orderFragment.test();
        ...
        btnOrderCheck = findViewById(R.id.btn_order_dialog_check);
        btnOrderCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity mainActivity = new MainActivity();
                mainActivity.changeCheckStatus(position, context, key);
                dismiss();
            }
        });
    }
